      ...
      >
        <div className="space-y-4">
          <div>
            ...
            <div className="mt-2 break-words text-[2.5rem] leading-none sm:text-5xl font-bold tracking-tight text-foreground">
...
function SummaryLine({
  ...
  return (
    <div className="flex flex-col items-start gap-1.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
      ...
      <span className="font-medium text-foreground sm:shrink-0">{value}</span>
    </div>
  );
}
        ...
        return (
          <div key={category.name} className={cn(insetTileClass, "shadow-sm")}>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="text-left font-medium text-foreground sm:shrink-0 sm:text-right">
