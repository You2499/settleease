            ...
            <Card>
              ...
              <CardContent className="text-sm sm:text-base space-y-2 sm:space-y-3 pt-0">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between">
                  ...
                  <span className="font-medium flex items-center self-start sm:self-auto"><CategoryIcon className="mr-1.5 h-5 w-5" /> {expense.category}</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between">
                ...
                {celebrationContributionOpt && (
                  <>
                    ...
                    <div className="flex items-center text-yellow-600 dark:text-yellow-400">
                        <PartyPopper className="mr-2 h-5 w-5 flex-shrink-0"/>
                                            ...
                                            >
                                              {itemsByCategory[catName].map(itemShare => (
                                                <li
                                                  ...
                                                  style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', justifyContent: 'space-between' }}
                                                >
                  ...
                  ((() => {
                    ...
                    return (
                      <ul className="space-y-2 sm:space-y-2.5">
                        {peopleWithNetEffect.map(({ personId, personName, amountPhysicallyPaidByThisPerson, shareOfSplitAmountForThisPerson, isCelebrationContributor, celebrationAmountByThisPerson, netEffectForThisPerson }) => (
