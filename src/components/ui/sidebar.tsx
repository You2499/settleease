...
>(
  (
    ...
    if (typeof tooltip === "string") {
      ...
      const { content, children, ...restTooltip } = tooltip
      tooltipProps = {
        ...restTooltip,
...
>(({ className, showIcon = false, textWidth = "72%", ...props }, ref) => {
  return (
    <div
      ref={ref}
